<div>
    <main class="main">
        <div class="flex shadow-lg justify-start bg-white text-blue-600 dark:text-gray-400 dark:bg-slate-800">
            <p class="border p-2 mb-1">We Hebben <strong class="search-result">{{ $products->total() }}</strong> Producten Gevonden</p>
            
            <div class="border p-2 mb-1" x-data="{ open: false }">
                <button @click="open = true">Producten Per Pagina</button>
         
                <ul class="absolute z-10 w-32 flex flex-col" x-show="open" @click.outside="open = false">
                    <li class="place-self-end bg-white text-blue-600 dark:text-gray-400 dark:bg-slate-800"><a href="#">8</a></li>
                    <li class="place-self-end bg-white text-blue-600 dark:text-gray-400 dark:bg-slate-800"><a href="#">16</a></li>
                    <li class="place-self-end bg-white text-blue-600 dark:text-gray-400 dark:bg-slate-800"><a href="#">24</a></li>
                </ul>
            </div>
            <div class="border p-2 mb-1" x-data="{ open: false }">
                <button @click="open = true">sorteer</button>
         
                <ul class="absolute z-10 " x-show="open" @click.outside="open = false">
                    <li class=""><a href="#">featured</a></li>
                    <li class=""><a href="#">dolma</a></li>
                    <li class=""><a href="#">kebab</a></li>
                </ul>
            </div>
