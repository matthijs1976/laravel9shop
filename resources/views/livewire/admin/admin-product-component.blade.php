                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody class="bg-white text-blue-600 dark:text-white dark:bg-gray-700">
                                ...
                                @foreach ($products as $product)
                                    ...
                                    <td class="flex justify-start gap-8 py-3 px-4">
                                        ...
                                        {{-- delete product delete btn and modal  --}}
                                        <div x-data="{ modelOpen: false }">
                                            <button @click="modelOpen =!modelOpen"
                                                onclick="deleteConfirmation({{ $product->id }})"
                                                class="button open-button py-3 px-3 text-red-700 hover:text-orange-500">
