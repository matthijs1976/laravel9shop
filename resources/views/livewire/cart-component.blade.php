        ...
        <div class="mt-8">
          ...
          <ul class="space-y-4">
            <li class="flex items-center gap-4">
              ...
              <div class="flex flex-1 items-center justify-end gap-2">
                <button wire:click.prevent="incQuantity('{{ $item->rowId }}')" class="text-gray-600 transition hover:text-red-600">
                  <span class="sr-only">Add item</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5" />
                </svg>
                </button>
                <button wire:click.prevent="decQuantity('{{ $item->rowId }}')" class="text-gray-600 transition hover:text-red-600">
                ...
                <button wire:click.prevent="destroy('{{ $item->rowId}}')"class="text-gray-600 transition hover:text-red-600">
                  <span class="sr-only">Remove items</span>
          ...
          <div class="mt-8 flex justify-end border-t border-gray-100 pt-8">
            <div class="w-screen max-w-lg space-y-4">
              ...
              @if(Cart::count() > 1) 
              <div class="flex justify-end">
                <button wire:click.prevent="clearAll()" class="inline-flex items-center justify-center rounded-full bg-red-100 px-2.5 py-0.5 text-blue-600">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" />
                </svg>   
                  <p class="whitespace-nowrap text-xs">Leeg Winkelmandje</p>                  
              </button>                
              </div>
              @endif  
              <div class="flex justify-end">
